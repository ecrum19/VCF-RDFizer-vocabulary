...
successor with `owl:equivalentClass`, `owl:equivalentProperty` or `owl:sameAs`. Redirecting to the new
vocabulary would resolve a legacy IRI to a document that does not define it, which is less useful to a
consumer than a 404.
